...
public class TopicController {
	...
	public @ResponseBody JsonShowList getTopicGraph(@PathVariable int topicId,
			int depth) {
		Topic topic = topicDao.getById(topicId);
	...
	public @ResponseBody List<ExpertForList> getTopTen(@PathVariable int topicId) {
		return EntitiesForListUtil.expertForLists(topicDao.getTopTen(topicId));
	}
	...
	public @ResponseBody List<JsonData> getExpertGender(
			@PathVariable int topicId) {
