...
public class BackendPatentController {
	...
	public String add(String title,String applicant,String abs,
			String[] inventors,String date, String orgnization, String type, RedirectAttributes redirectAttributes) throws ParseException {
		
		addService.addPatent(title, applicant, abs, inventors, date, orgnization, type);
