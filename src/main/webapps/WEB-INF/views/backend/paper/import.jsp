...
<link rel="stylesheet" href="/robot/resources/css/backend/paper-import.css" />
</head>
<body>
	<!-- navbar -->
	...
	<div class="container-fluid">
		<div id="pad-wrapper" class="new-user">
			...
			<div class="row-fluid form-wrapper">
				<div class="container">
					<form class="import-paper-form inline-input">
	...
	<script src="/robot/resources/js/backend/paper-import.js"></script>
</body>
</html>