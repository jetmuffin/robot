...
<link rel="stylesheet"
	href="/robot/resources/css/backend/paper-form.css" type="text/css"
	media="screen" />
...
<body>
	...
	<div class="content">
		...
		<div class="container-fluid">
			<div id="pad-wrapper" class="new-paper">
				...
				<div class="row-fluid form-wrapper">
					...
					<div class="span9 with-sidebar">
						<div class="container">
						<form  class="paper-form inline-input" 
						action="/robot/backend/paper/add" method="post" id="paper-form">
	...
	<script src="/robot/resources/js/backend/paper-form.js"></script>
</body>
</html>