...
<link rel="stylesheet"
	href="/robot/resources/css/backend/patent-form.css" type="text/css"
	media="screen" />
...
<body>
	...
	<div class="content">
		...
		<div class="container-fluid">
			<div id="pad-wrapper" class="new-patent">
				...
				<div class="row-fluid form-wrapper">
					...
					<div class="span9 with-sidebar">
						<div class="container">
						<form  class="patent-form inline-input" 
						action="/robot/backend/patent/add" method="post" id="patent-form">
	...
	<script src="/robot/resources/js/backend/patent-form.js"></script>
</body>
</html>